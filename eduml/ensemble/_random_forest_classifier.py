...
class RandomForestClassifier(BaggingClassifier):
    def __init__(self, 
                 ...
                 number_of_trees=10, sample_size=1, bootstrap=True, random_state=0): 


        super().__init__(model=DecisionTreeClassifier(criterion=criterion, max_depth=max_depth, max_features='auto'), 
                         m=number_of_trees,
